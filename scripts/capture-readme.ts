...
try {
  ...
  await delay(600);
  const battleVideo = await stopBattleCapture();
  await context.close();
    ...
    JSON.stringify(
      {
        ...
        zoom: 1,
        capture: 'Lossless PNG screencast frames, original timestamps',
        mp4: { width: 1920, height: 1280, fps: 30, crf: 16 },
        gif: { width: 1440, height: 960, fps: 12, colors: 256 },
      },
      null,
      2,
    ) + '\n',
